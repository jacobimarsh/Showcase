...
const App = () => {
  ...
  return (
    <div ref={containerRef} className="h-screen overflow-auto p-10">
      ...
      <button 
      onClick={scrollToTop} 
      className="fixed bottom-4 right-4 translate-x-[calc(50%-7.5px)] rounded-full opacity-45 hover:opacity-100 transition-opacity duration-300 flex items-center justify-center mr-3 mb-5"
      title="Back to Top">
